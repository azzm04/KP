...
import log from "../../collections/SignIn.svg";
import register from "../../collections/oranglogin-rmv.png";
        ...
        isSignUpMode ? "" : "lg:translate-x-[800px]   max-lg:translate-y-[300px]"
            ...
            >
              ...
              <p className=" py-2 text-[0.7rem] lg:text-[0.95rem] px-0  lg:py-[0.7rem]">
                Sign in now for a more practical and hassle-free shopping experience
              </p>
              <button
